...
class Widget():
    ...
    #--------------------------------------------------------------------------------------------------------------------------------------------------------
    greet = ['Hey Whats up! How are you doing', 'Hello Aryan Sir ','Hi ! I am your Assistant','Hello, How can I help You']
    how = ['I am Fine Sir, What about You','I am fine as always', 'what you think','just fine!!']
    name = ['You Can call me MARKAS ','My Name Is MARKAS','you named me MARKAS','You Should Know this, My name Is MARKAS']
    creator = ['You made Me','I was Made by Aryan sir ','One And only, Aryan sir','Best in the World, sir']
    ...
    frnd = ['I will Feel Lucky To Be Your Friend','Yaa Ofcource']
    me = ['You Told Me Your Name, Aryan','I Think That\'s Aryan','Your Name That I Know Is Aryan']
    ...
    def more(self):
        ...
        more.geometry('500x350+400+550')

        

        
        Label(more, text='MARKAS - The Virtual Assistant',bg='powder blue',font=('Arial Black',10,'bold')).pack()

        Label(more, text='By: Aryan',bg='powder blue',font=('Arial Black',10,'bold')).pack()
        
        out = 'My Name Is Aryan. I Was Created By Aryan. \n He Made Me Using Python Language. I Was Made\n As A Project For Him. But Later I Turned Really Well.\n So He Started Working Really Hard On Me. His\n Progress In Me Was Just Great. So, Now I Am His One\n Of The Dream Project Which He Is Planning\n To Build For Cross-Platform.'
        
        Label(more, text=out,bg='powder blue',font=('Arial Black',10,'bold')).pack()
        
        Label(more, text='Contact us at:\7408846460',bg='powder blue',font=('Arial Black',10,'bold')).pack(side=LEFT)
    ...
    #-----------------------SEND FUNC-----------------------------------------------------------------
    #        THIS FUCTION IS BEING USED TO SEND USER_INPUT TO MARKAS.
    #--------------------------------------------------------------------------------------------------------
    def send_func(self):
    ...
    #-------------------------------------------------------------------------------------------------------
        ...
        #------------------------------------CONDITIONS------------------------------------------------------------------------------------------
        # THESE ARE CONDITIONS WHICH THE MARKAS CHECKS. HE RESPOND TO THE MOST RELEVENT CONDITION.
        #-------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        #-----------------ASSISTENT CONDITION-------------------------------------------------------------------
        elif 'Aryan  singh'  in user_input:
            out = 'Aman  Singh Is A Good Friend Of Aryan Sir. He is well Known as Vikarm'                                                                                               #|   
            self.printing_func(out)                                                                                    #|
            self.speak(out)
        #-----------------------------------------------------------------------------------------------------------------------
       ...
       #--------------------------THANKS CONDITION-------------------------------------------------------   
        ...
        #-----------------------------GOOD MORNING CONDITION--------------------------------------------------------------------------------
            ...
            out = f'Good Morning Aryan Sir, The Current Time is {time},  And {outa},    Have A Good Day Sir.'
            self.printing_func(out)
            self.speak(out)
        #--------------------------------------------------------------------------------------------------------------------------------------------------------            
        ...
        #----------------OPEN CONDITIONS -----------------------------------------
            ...
            if 'google' in user_input:
                ...
                self.printing_func(out)
                self.speak(out)
                path = r'C:\Users\Aryan Singh\Downloads\Video.exe'
                os.startfile(path)
                ...
                self.printing_func(out)
                self.speak(out)
                path = r"C:\Users\Aryan Singh\AppData\Local\Programs\Microsoft VS Code\Code.exe"
                os.startfile(path)
                ...
                self.printing_func(out)
                self.speak(out)
                path = r'C:\Users\Aryan Singh\Desktop.exe'
                os.startfile(path)
    ...
    def __init__(self):
        ...
        Label(self.win, text='Me' , font=('arial black',20),fg='white',bg='orange').place(x=60,y=60)
        Label(self.win, text='MARKAS' , font=('arial black',20),fg='white',bg='orange').place(x=220,y=60)
